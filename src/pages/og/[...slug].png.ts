...
function loadLocalFonts() {
	const regular = fs.readFileSync("./src/assets/fonts/NotoSansSC-Regular.woff");
	const bold = fs.readFileSync("./src/assets/fonts/NotoSansSC-Bold.woff");
	return { regular, bold };
}
...
export async function GET({
	...
	// Read Noto Sans SC fonts from local files (no network dependency)
	const { regular: fontRegular, bold: fontBold } = loadLocalFonts();
